    ...
    def analyze_task_difficulty(self, prompt, max_new_tokens=10):
        ...
        try:
            with torch.no_grad():
                ...
                # # Debug prints
                # print(f"  Debug: Top prob: {top_prob:.6f}")
                # print(f"  Debug: Probs dtype: {probs.dtype}")
                # print(f"  Debug: Probs_f32 dtype: {probs_f32.dtype}")
                # print(f"  Debug: Entropy before storing: {entropy:.6f}")
                # print(f"  Debug: Is entropy NaN? {np.isnan(entropy)}")
                # print(f"  Debug: Is entropy inf? {np.isinf(entropy)}")
        ...
        return self.compute_difficulty_metrics()
